...
<div class="container mt-80 mb-80 future-landscapes-main">
    <div class="row">
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./land"><img src="/assets/img/australia/land.jpg" alt="Land"></a>
                <div class="data-heading">
                    <h4><a href="./land">Land</a></h4>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./marine"><img src="/assets/img/australia/marine.jpg" alt="Marine"></a>
                <div class="data-heading">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./atmosphere"><img src="/assets/img/australia/atmosphere.jpg" alt="Atmosphere"></a>
                <div class="data-heading">
