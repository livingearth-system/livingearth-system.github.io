    ...
    <div class="dsc-about-page container">
        <div class="row">
            <div class="dsc-about-inner col-12 col-md-5">
                <h3 class="mb-3 mb-md-4 text-uppercase">Land</h3>
            </div>
        </div>
...
<div class="container mt-80 mb-80 future-landscapes-main">
    <div class="row">
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./vegetation"><img src="/assets/img/australia/vegetation.jpg" alt="Vegetation"></a>
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./snow"><img src="/assets/img/australia/snow.jpg" alt="Snow"></a>
                <div class="data-heading">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./urban"><img src="/assets/img/australia/urban.jpg" alt="Urban"></a>
                <div class="data-heading">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./water"><img src="/assets/img/australia/water.jpg" alt="Water"></a>
                <div class="data-heading">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./soil"><img src="/assets/img/australia/soil.jpg" alt="Soil"></a>
                <div class="data-heading">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./energy"><img src="/assets/img/australia/energy.jpg" alt="Energy"></a>
                <div class="data-heading">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="data-item">
                <a href="./terrain"><img src="/assets/img/australia/land.jpg" alt="Terrain"></a>
                <div class="data-heading">
