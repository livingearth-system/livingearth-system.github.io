        ...
        <div class="row text-white">
            <div class="col-12">
                <ul class="breadcrumbs list-unstyled d-flex">
                    <li class="breadcrumbs-item"><a href="/">Home</a></li><span class="separator1">/</span> <a href="/europe">Europe</a><span class="separator1">/</span> <a href="/europe/wales/">Wales</a><span class="separator1">/</span> Tools
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="dsc-countrypage-inner col-12 col-md-5">
                <h3 class="mb-3 mb-md-4 text-uppercase">Tools</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
...
<div class="container mt-100 mb-100 tools-main">
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <a href="/europe/wales/data/"><img src="/assets/img/tools2.jpg" alt="Get the data"/></a>
            <div class="pastcurrent-dsc">
                <h4><a href="/europe/wales/data/">Get the data</a></h4>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <a href="./bigdata"><img src="/assets/img/tools5.jpg" alt=""></a>
            <div class="pastcurrent-dsc">
